...
class ProjectApprovalConfigValidatorTest {
    ...
    void missingSmeApprovalFieldIsFatal() {
        assertFatal(validConfig(null, SQA_FIELD, fields(TITLE_FIELD), users("ana@example.com"), users("sam@example.com"), "bot@example.com", workItemTypes("Test Case")),
                "Missing SME approval field config.");
    }

    @Test
    void missingSqaApprovalFieldIsFatal() {
        assertFatal(validConfig(SME_FIELD, " ", fields(TITLE_FIELD), users("ana@example.com"), users("sam@example.com"), "bot@example.com", workItemTypes("Test Case")),
                "Missing SQA approval field config.");
    }

    @Test
    void missingSmeUsersIsFatal() {
        assertFatal(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD), Set.of(), users("sam@example.com"), "bot@example.com", workItemTypes("Test Case")),
                "Missing SME users.");
    }

    @Test
    void missingSqaUsersIsFatal() {
        assertFatal(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD), users("ana@example.com"), null, "bot@example.com", workItemTypes("Test Case")),
                "Missing SQA users.");
    }

    @Test
    void invalidSmeEmailIsFatal() {
        assertFatal(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD), users("not-an-email"), users("sam@example.com"), "bot@example.com", workItemTypes("Test Case")),
                "Invalid SME email entry.");
    }

    @Test
    void invalidSqaEmailIsFatal() {
        assertFatal(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD), users("ana@example.com"), users("sam"), "bot@example.com", workItemTypes("Test Case")),
                "Invalid SQA email entry.");
    }

    @Test
    void missingBotIdentityEmailIsFatal() {
        assertFatal(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD), users("ana@example.com"), users("sam@example.com"), "", workItemTypes("Test Case")),
                "Missing bot identity email.");
    }

    @Test
    void invalidBotIdentityEmailIsFatal() {
        assertFatal(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD), users("ana@example.com"), users("sam@example.com"), "bot", workItemTypes("Test Case")),
                "Invalid bot identity email.");
    }

    @Test
    void approvalFieldInsideReversibleBusinessFieldsIsFatal() {
        assertFatal(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD, SME_FIELD), users("ana@example.com"), users("sam@example.com"), "bot@example.com", workItemTypes("Test Case")),
                "SME approval field appears in reversible business fields.");
    }

    @Test
    void systemStateInsideReversibleBusinessFieldsIsFatal() {
        assertFatal(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD, "System.State"), users("ana@example.com"), users("sam@example.com"), "bot@example.com", workItemTypes("Test Case")),
                "System.State appears in reversible business fields.");
    }

    @Test
    void missingSupportedWorkItemTypesIsFatal() {
        assertFatal(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD), users("ana@example.com"), users("sam@example.com"), "bot@example.com", Set.of()),
                "Supported work item types are missing or empty.");
    }

    @Test
    void enabledProjectWithoutTestCaseSupportIsFatal() {
        assertFatal(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD), users("ana@example.com"), users("sam@example.com"), "bot@example.com", workItemTypes("Bug")),
                "Enabled V1 project must support Test Case work item type.");
    }

    @Test
    void missingReversibleBusinessFieldsIsFatal() {
        assertFatal(validConfig(SME_FIELD, SQA_FIELD, null, users("ana@example.com"), users("sam@example.com"), "bot@example.com", workItemTypes("Test Case")),
    ...
    void duplicateSqaEmailCreatesWarning() {
        var result = validator.validate(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD), users("ana@example.com"), users("Sam@Example.com", " sam@example.com "), "bot@example.com", workItemTypes("Test Case")));
    ...
    void sameEmailInSmeAndSqaCreatesWarningNotFatal() {
        var result = validator.validate(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD), users("dual@example.com"), users("DUAL@example.com"), "bot@example.com", workItemTypes("Test Case")));
    ...
    void disabledProjectWithOtherwiseInvalidConfigDoesNotProduceFatalErrors() {
        var result = validator.validate(new ProjectApprovalConfig(
                "ProjectA",
                false,
                null,
                null,
    ...
    void emailNormalizationUsesTrimAndLowercase() {
        var result = validator.validate(validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD), users(" ANA@example.com "), users(" SAM@example.com "), " BOT@example.com ", workItemTypes("Test Case")));
    ...
    private ProjectApprovalConfig validConfig() {
        return validConfig(SME_FIELD, SQA_FIELD, fields(TITLE_FIELD), users("ana@example.com"), users("sam@example.com"), "bot@example.com", workItemTypes("Test Case"));
    }
