...
class EventClassifierTest {
    ...
    void missingProjectIsMalformed() {
        var classification = classifier.classify(event(" ", 123L, "Test Case", 27, "User", "user@example.com", Set.of()), config(true, "Test Case"));
    ...
    void missingWorkItemIdIsMalformed() {
        var classification = classifier.classify(event("ProjectA", null, "Test Case", 27, "User", "user@example.com", Set.of()), config(true, "Test Case"));
    ...
    void invalidWorkItemIdIsMalformed() {
        var classification = classifier.classify(event("ProjectA", 0L, "Test Case", 27, "User", "user@example.com", Set.of()), config(true, "Test Case"));
    ...
    void missingRevisionIsMalformed() {
        var classification = classifier.classify(event("ProjectA", 123L, "Test Case", null, "User", "user@example.com", Set.of()), config(true, "Test Case"));
    ...
    void invalidRevisionIsMalformed() {
        var classification = classifier.classify(event("ProjectA", 123L, "Test Case", -1, "User", "user@example.com", Set.of()), config(true, "Test Case"));
    ...
    void changedByEmailMatchingBotIdentityIsSkippedAsBotEvent() {
        var classification = classifier.classify(event("ProjectA", 123L, "Test Case", 27, "Any Name", "bot@example.com", Set.of()), config(true, "Test Case"));
    ...
    void changedByDisplayNameMatchingBotButMissingEmailIsNotSkippedAsBot() {
        var classification = classifier.classify(event("ProjectA", 123L, "Test Case", 27, "Approval Bot", null, Set.of()), config(true, "Test Case"));
    ...
    void missingChangedByEmailRemainsProcessableWhenEventIsOtherwiseValid() {
        var classification = classifier.classify(event("ProjectA", 123L, "Test Case", 27, "Human User", null, Set.of()), config(true, "Test Case"));
    ...
    void unconfiguredChangedFieldsDoNotCauseSkipHere() {
        var classification = classifier.classify(event("ProjectA", 123L, "Test Case", 27, "User", "user@example.com", Set.of("Custom.Unconfigured")), config(true, "Test Case"));
    ...
    void systemStateChangeIsNotClassifiedAsContentHere() {
        var classification = classifier.classify(event("ProjectA", 123L, "Test Case", 27, "User", "user@example.com", Set.of("System.State")), config(true, "Test Case"));
    ...
    void approvalFieldChangeIsNotClassifiedAsApprovalHere() {
        var classification = classifier.classify(event("ProjectA", 123L, "Test Case", 27, "User", "user@example.com", Set.of(SME_FIELD)), config(true, "Test Case"));
    ...
    void classifierDoesNotDependOnSpringMvcOrControllerClasses() {
        assertNoForbiddenTypeReferences("org.springframework.web", EventClassifier.class, AdoWebhookEvent.class, AdoWebhookResource.class);
        assertNoForbiddenTypeReferences("Controller", EventClassifier.class, AdoWebhookEvent.class, AdoWebhookResource.class);
    }

    @Test
    void classifierDoesNotDependOnHttpClientClasses() {
        assertNoForbiddenTypeReferences("WebClient", EventClassifier.class, AdoWebhookEvent.class, AdoWebhookResource.class);
        assertNoForbiddenTypeReferences("RestTemplate", EventClassifier.class, AdoWebhookEvent.class, AdoWebhookResource.class);
        assertNoForbiddenTypeReferences("ResponseEntity", EventClassifier.class, AdoWebhookEvent.class, AdoWebhookResource.class);
        assertNoForbiddenTypeReferences("HttpClient", EventClassifier.class, AdoWebhookEvent.class, AdoWebhookResource.class);
    }
    ...
    private AdoWebhookEvent event(String project, Long workItemId, String workItemType, Integer revision, String displayName, String email, Set<String> changedFields) {
        return AdoWebhookEvent.workItemUpdated("org", project, workItemId, workItemType, revision, displayName, email, changedFields);
    }
