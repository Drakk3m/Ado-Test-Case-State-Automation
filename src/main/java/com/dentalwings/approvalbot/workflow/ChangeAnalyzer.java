...
public class ChangeAnalyzer
{
    ...
    public Set<String> changedReversibleFields(Map<String, Object> previousFields, Map<String, Object> currentFields,
            ProjectApprovalConfig config)
    {
        var changed = new LinkedHashSet<String>();
        for (String field : config.reversibleBusinessFields())
        {
            if ("System.State".equals(field) || field.equals(config.approvedBySmeField())
