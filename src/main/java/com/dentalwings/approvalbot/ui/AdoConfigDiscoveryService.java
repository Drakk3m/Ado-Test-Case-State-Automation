...
public interface AdoConfigDiscoveryService
{
    ...
    default ConfigLookupResult<ConfigSelectorOption> listFieldOptions(String organization, String project,
            String workItemType)
    {
    ...
    default ConfigLookupResult<ConfigSelectorOption> listStateOptions(String organization, String project,
            String workItemType)
    {
    ...
    default ConfigLookupResult<ConfigSelectorOption> searchIdentityOptions(String organization, String query)
    {
        return ConfigLookupResult
                .warning("ADO user discovery is not available yet; use email/login values, not display names.");
    }

    default ConfigLookupResult<ConfigSelectorOption> searchIdentityOptions(String organization, String project,
            String query)
    {
    ...
    {
        return new ConfigLookupResult<>(lookup.status(), lookup.message(),
