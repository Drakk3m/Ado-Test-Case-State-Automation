...
public record WebhookProcessingResult(WebhookProcessingStatus status, String reason, EventClassification classification,
                                      WorkItemProcessingResult workItemProcessingResult)
{
    ...
    {
        return new WebhookProcessingResult(WebhookProcessingStatus.FAILED_MALFORMED_EVENT, reason, classification,
                null);
    }

    public static WebhookProcessingResult fromWorkItemResult(WorkItemProcessingResult result,
